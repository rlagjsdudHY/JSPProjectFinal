    ...
    <div id="wrap">
    	...
    	<main id="main" class="dFlex">
    		...
    		<div id="contents" class="bbsList">
    			...
    			int NnumPerPage = 3;    // 페이지당 출력하는 데이터 수(=게시글 숫자)
  ...
  boolean hasAttachment = filename != null && !filename.isEmpty(); // 파일 첨부 여부
				...
				%>
					...
					<tr id="listBtnArea">
						<td colspan="2">
						<% if (uidSession == null) { %>
							<button type="button" id="BloginAlertBtn" class="listBtnStyle">글쓰기</button>
						<% } else { %>
							<button type="button" id="BwriteBtn" class="listBtnStyle">글쓰기</button>
						<% } %>
						</td>
